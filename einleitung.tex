...
\Cref{ch:communications} contains all the messages and emails exchanged in the course of this work.
All notes which were made during the research can be found in \cref{ch:notes}.

The entire work is written in English because all mathematical literature is in that language. % TODO better explenation

% TODO check pronoun usage
