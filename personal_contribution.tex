...
First, the logics FO$[t(n)]$, which formalizes iterative definitions, and VAR$[k]$, which restricts the number of variables but allows for unbounded first-order iterations, are defined.
