...
\begin{proof}
    \begin{align*}
        ...
        &= \bigcup_{k\in \mathbb{N}}^{\infty}\text{DSPACE}[\mathcal{O}(n^{k})] & \text{by definition} \\
        &= \text{PSPACE} \\
        &\subseteq \bigcup_{k\in \mathbb{N}}^{\infty}\text{NSPACE}[\mathcal{O}(n^{k})] & \text{by definition} \\
        &= \text{NPSPACE} & \text{by definition}
    \end{align*}
\end{proof}
