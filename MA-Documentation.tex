...
\usepackage[dvipsnames]{xcolor}               % Farbiger Text
...
colorlinks=true,          % Farbige Links: true, Link-Boxen: false
linkcolor=Mahogany,             % Farbe interner Links
citecolor=ForestGreen,           % Farbe der Zitat-Links
...
\input{descriptive_complexity}
\input{personal_contribution}
\input{conclusion_direction}
\input{danksagung}
% --------------------------
